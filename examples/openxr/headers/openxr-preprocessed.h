...
typedef struct __attribute__((__may_alias__)) XrSwapchainImageBaseHeader {
    XrStructureType type;
    void* __attribute__((__may_alias__)) next;
...
typedef struct __attribute__((__may_alias__)) XrCompositionLayerBaseHeader {
    XrStructureType type;
    const void* __attribute__((__may_alias__)) next;
...
typedef struct __attribute__((__may_alias__)) XrHapticBaseHeader {
    XrStructureType type;
    const void* __attribute__((__may_alias__)) next;
} XrHapticBaseHeader;

typedef struct __attribute__((__may_alias__)) XrBaseInStructure {
    XrStructureType type;
    const struct XrBaseInStructure* next;
} XrBaseInStructure;

typedef struct __attribute__((__may_alias__)) XrBaseOutStructure {
    XrStructureType type;
...
typedef struct __attribute__((__may_alias__)) XrEventDataBaseHeader {
    XrStructureType type;
    const void* __attribute__((__may_alias__)) next;
...
typedef XrResult (XRAPI_PTR *PFN_xrResultToString)(XrInstance instance, XrResult value, char buffer[64]);
typedef XrResult (XRAPI_PTR *PFN_xrStructureTypeToString)(XrInstance instance, XrStructureType value, char buffer[64]);
...
typedef struct __attribute__((__may_alias__)) XrLoaderInitInfoBaseHeaderKHR {
    XrStructureType type;
    const void* __attribute__((__may_alias__)) next;
...
typedef struct XrDebugUtilsMessengerCreateInfoEXT {
    ...
    void* __attribute__((__may_alias__)) userData;
...
// Extra things not to be preprocessed out
...
// openxr_platform-preprocessed.h
